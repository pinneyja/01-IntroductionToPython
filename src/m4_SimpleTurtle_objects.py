...
natasha.speed = 10  # Now slower
natasha.go_to(rg.Point(-100, 200))
natasha = rg.SimpleTurtle('classic')
natasha.pen = rg.Pen('purple', 7)
...
jacob = rg.SimpleTurtle()
jacob.speed = 10
jacob.pen = rg.Pen('orange', 5)
jacob.draw_square(50)
